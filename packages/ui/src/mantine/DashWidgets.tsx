...
export function DashWidgets() {
  ...
  const users = [
  { user: "Jane Green-McCoy", online: "offline", industry: "InfoTeh", country: 'USA' },
  { user: "John V-Putin", online: "online", industry: "InfoTeh", country: 'India' },
  { user: "Scott Snow-Dean", online: "online", industry: "Government", country: 'USA' },
  { user: "Mark Krystal-Nache", online: "online", industry: "AI", country: 'Japan' },
  { user: "Dan Brittney-Ali", online: "offline", industry: "Legal", country: 'China' },
];

  const usersRows = users.map((users) => (
    <Table.Tr key={users.user}>
      <Table.Td>{users.user}</Table.Td>
      <Table.Td><Badge color={users.online == "online" ? "blue" : "grey"}>{users.online}</Badge></Table.Td>
      <Table.Td>{users.industry}</Table.Td>
      <Table.Td>{users.country}</Table.Td>
    </Table.Tr>
  ));	
